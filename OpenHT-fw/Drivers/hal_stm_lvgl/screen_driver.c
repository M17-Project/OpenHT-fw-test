...
//#define LCD_SCREEN_WIDTH NT35510_800X480_WIDTH
//#define LCD_SCREEN_HEIGHT NT35510_800X480_HEIGHT

/* Width and Height in Portrait mode */
#define LCD_SCREEN_WIDTH NT35510_480X800_WIDTH
#define LCD_SCREEN_HEIGHT NT35510_480X800_HEIGHT
...
void screen_driver_init(){
	...
	//lv_display_driver.full_refresh = 0;
	//lv_display_driver.sw_rotate = 0;
	//lv_display_driver.rotated = LV_DISP_ROT_270;
	lv_display_driver.hor_res = LCD_SCREEN_WIDTH; //NT35510_480X800_HEIGHT;
	lv_display_driver.ver_res = LCD_SCREEN_HEIGHT; //NT35510_480X800_WIDTH;
