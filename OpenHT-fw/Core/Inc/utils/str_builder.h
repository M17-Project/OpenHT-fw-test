...
/*! Add a mag decimals to the builder.
 *
 * param[in,out] sb  Builder.
 * param[in]     val float to add.
 * param[in]     decimal_places number of decimal places to truncate.
 */
void str_builder_add_mag_val_decimal(str_builder_t *sb, int val, int decimal_places);
