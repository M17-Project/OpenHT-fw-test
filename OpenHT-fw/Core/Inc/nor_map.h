...
// Radio settings (sectors 4-7)
#define RADIO_SETTINGS_NB_SECTORS	4
#define RADIO_SETTINGS_START_SECTOR 4
#define RADIO_SETTINGS_START_ADDRESS	(RADIO_SETTINGS_START_SECTOR*SUBSECTOR_SIZE)
...
// FPGA binaries storage (sectors 16-2064)
#define FPGA_BIN_STORAGE_START_SECTOR 	16
