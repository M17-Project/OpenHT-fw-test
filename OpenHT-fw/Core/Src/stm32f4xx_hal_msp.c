...
static void HAL_FMC_MspDeInit(void)
{
	...
	HAL_GPIO_DeInit(GPIOE,
			FMC_NBL1_Pin | FMC_NBL0_Pin | D5_Pin | D6_Pin | D8_Pin | D11_Pin
					| D4_Pin | D7_Pin | D9_Pin | D12_Pin | D10_Pin);
	...
	HAL_GPIO_DeInit(GPIOI,
			FMC_NBL2_Pin | D27_Pin | D26_Pin | FMC_NBL3_Pin | D29_Pin | D31_Pin
					| D28_Pin | D25_Pin | D30_Pin | D24_Pin);

	HAL_GPIO_DeInit(GPIOF,
			A0_Pin | A1_Pin | A2_Pin | A3_Pin | A4_Pin | A5_Pin | A6_Pin
					| A9_Pin | A7_Pin | A8_Pin
					| SDNMT48LC4M32B2B5_6A_RAS_RAS___Pin);

	HAL_GPIO_DeInit(GPIOH,
			D23_Pin | D21_Pin | D22_Pin | SDNE0_Pin | SDCKE0_Pin | D20_Pin
					| D17_Pin | D19_Pin | D16_Pin | D18_Pin);
